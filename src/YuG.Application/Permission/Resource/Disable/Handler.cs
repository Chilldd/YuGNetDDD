...
/// 禁用资源命令处理器
/// </summary>
public class Handler : IRequestHandler<DisableResourceCommand, ResourceResult>
{
    ...
    public async Task<ResourceResult> Handle(DisableResourceCommand request, CancellationToken cancellationToken)
    {
        // 获取资源
