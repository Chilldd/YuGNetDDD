...
namespace YuG.Application.Permission.Resource.Commands.Update;

/// <summary>
/// 更新资源命令处理器
/// </summary>
public class Handler : IRequestHandler<UpdateResourceCommand, ResourceResult>
{
    ...
    public async Task<ResourceResult> Handle(UpdateResourceCommand request, CancellationToken cancellationToken)
    {
        // 获取资源
